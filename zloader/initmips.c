...
#ifndef NOCACHE2
inline __attribute__((always_inline)) void flush_cache2()
{
asm volatile(
".set mips3;\n" \
"	li	  $2, 0x80000000;\n" \
...
#else
inline __attribute__((always_inline)) void flush_cache()
{
...
{
    long *edata=(void *)0x800ced30;
    long *end=(void *)0x800f8f28;
    int *p;
	int debug=(msize==0);
//	CPU_TLBClear();
